...
const MyOrderScreen = () => {
    ...
    useEffect(() => {
        ...
        const fetchOrders = () => {
            ...
            const unsubscribe = onSnapshot(q, (querySnapshot) => {
                ...
                setOrders(fetchedOrders);  // Update state with new orders
    ...
    const handleCancelOrder = (orderId) => {
        // Logic to cancel order (can update Firestore here if needed)
    };
