...
const MyOrderScreen = () => {
    ...
    useEffect(() => {
        const fetchOrders = () => {
            ...
            // Corrected query with 'userID' (capital D) to match your Firestore schema
            const q = query(
            ...
            const unsubscribe = onSnapshot(q, (querySnapshot) => {
                const fetchedOrders = querySnapshot.docs.map(doc => {
                    ...
                    return {
                        ...
                        userId: orderData.userID, // Corrected to 'userID'
                    };
                });
    ...
    const handleCancelOrder = (orderId) => {
        ...
        // Add logic to cancel the order here (e.g., updating Firestore status)
    };
    ...
    // Filter orders based on the active tab and render a message if none are found
