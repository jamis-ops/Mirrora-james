            ...
            const unsubscribe = onSnapshot(q, (querySnapshot) => {
                const fetchedOrders = querySnapshot.docs.map(doc => {
                    ...
                    return {
                        ...
                        addedAt: orderData.addedAt ? orderData.addedAt.toDate() : null,  // Convert addedAt Timestamp to Date (if exists)
                        items: orderData.items,  // Ensure this is an array of objects
