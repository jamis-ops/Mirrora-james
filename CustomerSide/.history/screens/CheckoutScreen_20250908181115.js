...
import { db, auth } from '../Backend/firebaseConfig'; // import db and auth from firebase config
...
export default function CheckoutScreen() { 
    ...
    const handlePlaceOrder = async () => {
        // Get the userId dynamically from Firebase Authentication
        ...
        try {
            const orderData = {
                userId: userId,  // Use the authenticated user's ID dynamically
                items: cartItems,
                total: total,
