...
import { Ionicons } from '@expo/vector-icons'; // Import for the back arrow and chat icons
    ...
    useEffect(() => {
        const fetchOrders = () => {
            ...
            const q = query(
                ...
                where('status', '==', activeTab), // Filter by the active tab
        ...
        setIsLoading(true); // Set loading to true whenever the tab changes
        fetchOrders();
    }, [activeTab]); // Rerun effect when activeTab changes

    const handleCancelOrder = (orderId) => {
        // Implement cancel logic here, e.g., update the order status in Firestore
                        ...
                        <View key={order.id} style={styles.orderCard}>
                            ...
                            <View style={styles.cardHeader}>
                                <View style={styles.userInfo}>
                                    ...
                                    <Text style={styles.userName}>John</Text> {/* Hardcoded as per image */}
                                </View>
                            ...
                            <View style={styles.orderBody}>
                                ...
                                <View style={styles.productDetails}>
                                    ...
                                    <Text style={styles.productSize}>Size: 60.2" x 51.2"</Text>
                                    <Text style={styles.orderDate}>Sep 3, 2025</Text>
...
const styles = StyleSheet.create({
    ...
    header: {
        ...
        borderBottomWidth: 1,
        borderBottomColor: '#E0E0E0',
        paddingTop: 50, // To account for the iPhone's notch area
    },
    headerIcon: {
        padding: 5,
    },
