...
const MyOrderScreen = () => {
    ...
    useEffect(() => {
        const fetchOrders = () => {
            ...
            // Set up query to get orders for the current user, ordered by createdAt (newest first)
            const q = query(
    ...
    // Handle changing the active tab (filter orders by status)
    const handleTabChange = (tab) => {
        setActiveTab(tab);
    };

    // Handle canceling an order (this is a placeholder function, you can implement the actual logic)
