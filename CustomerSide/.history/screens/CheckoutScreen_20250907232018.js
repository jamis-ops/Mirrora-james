...
export default function CheckoutScreen() {
    ...
    // This cartItems is a temporary mock. In a real app, this would come from a global state or Redux store.
    const [cartItems] = useState([
        { 
            id: 'IrregProduct2', 
            name: 'Floor Standing Mirror', // Changed to match the picture
            size: "60.2\" x 51.2\"", 
            price: 2220, // Changed to match the picture
            quantity: 1, 
            imageUrl: "https://via.placeholder.com/150" // Placeholder URL to match the picture
        },
    ]);
    ...
    const handleProceedToPlaceOrder = async () => {
        ...
        const orderData = {
            ...
            itemSize: cartItems[0].size,
            itemImageUrl: cartItems[0].imageUrl,
            itemQuantity: cartItems[0].quantity,
            totalPayment: total, // Corrected total payment variable name
