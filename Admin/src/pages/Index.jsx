      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-blue-700 mt-1">Order #ORD-006 from Sarah Johnson</p>
      ...
      <div className="bg-green-50 border border-green-200 rounded-lg p-4">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-green-700 mt-1">₱3,200 from Carlos Lopez</p>
      ...
      <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-yellow-700 mt-1">Classic Wall Mirror - Only 3 left</p>
...
const DashboardCard = ({ title, value, description, trend = "up", trendValue, color = "blue" }) => {
  const colorClasses = {
...
// Recent orders data
const recentOrders = [
  { id: "ORD-006", customer: "Sarah Johnson", product: "Round Decorative Mirror", amount: "₱2,100", status: "pending" },
  { id: "ORD-005", customer: "Lisa Chen", product: "Round Decorative Mirror", amount: "₱2,950", status: "confirmed" },
  { id: "ORD-004", customer: "Carlos Lopez", product: "Oval Bathroom Mirror Set", amount: "₱3,200", status: "delivered" },
];
...
const Loader = () => (
  <div className="flex flex-col flex-1 items-center justify-center min-h-screen bg-gray-50">
    ...
    <p className="mt-4 text-gray-700 text-lg font-medium">Loading dashboard...</p>
  </div>
);
        ...
        <div className="mb-8">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <p className="text-gray-600">Welcome back! Here's what's happening with your mirror business today.</p>
            </div>
            <div className="flex items-center gap-4 mt-4 lg:mt-0">
              <div className="flex items-center gap-2 bg-white px-4 py-2 rounded-lg border border-gray-200">
                <Calendar className="w-4 h-4 text-gray-500" />
                <span className="text-sm text-gray-700">Today, {new Date().toLocaleDateString()}</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="lg:col-span-2 bg-white rounded-xl p-6 shadow-sm border border-gray-200">
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-gray-600 text-sm">Monthly sales performance overview</p>
              </div>
              <div className="flex items-center gap-2">
            ...
            <div className="h-64 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg p-4 flex items-end justify-around">
              {salesData.map((item,) => (
                <div key={item.name} className="flex flex-col items-center">
                  <div 
                    className="bg-gradient-to-t from-blue-500 to-blue-400 rounded-t-md w-8 transition-all duration-300 hover:from-blue-600 hover:to-blue-500"
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
            <div className="flex items-center justify-between mb-6">
              <div>
                ...
                <p className="text-gray-600 text-sm">Best selling items this month</p>
              </div>
            ...
            <div className="space-y-4">
              {topProducts.map((product, index) => (
                <div key={product.name} className="flex items-center gap-4">
                  <div className="flex items-center justify-center w-8 h-8 bg-gradient-to-br from-amber-400 to-amber-500 text-white rounded-lg font-bold text-sm">
                    {index + 1}
                  </div>
                  <div className="flex-1">
