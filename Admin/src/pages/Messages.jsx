// src/pages/Messages.jsx (Admin Dashboard) - Enhanced with Form-Style Customization Display
    ...
    return (
      <div className="bg-green-50 border border-green-200 rounded-lg p-4 mb-2">
        ...
        <div className="text-sm space-y-1">
          <p><span className="font-medium">Price:</span> ₱{msg.quoteData.price}</p>
          <p><span className="font-medium">Timeline:</span> {msg.quoteData.timeline}</p>
          {msg.quoteData.notes && (
            <p><span className="font-medium">Notes:</span> {msg.quoteData.notes}</p>
          )}
        </div>
      </div>
    );
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between mb-1">
                      <span className={`text-sm font-semibold truncate ${
                        !thread.isRead ? 'text-[#2C1810]' : 'text-gray-700'
                      }`}>
                    ...
                    <p className={`text-xs truncate ${
                      !thread.isRead ? 'text-[#A0522D] font-bold' : 'text-gray-500'
                    }`}>
                      {thread.lastMessage}
                    </p>
                          ...
                          {msg.messageType !== 'customization_request' && msg.messageType !== 'quote' && (
                            <div className={`px-4 py-2 rounded-xl text-sm ${
                              ...
                              <span className={`block mt-1 text-xs text-right ${
                                isAdminMessage ? 'text-gray-200' : 'text-gray-500'
                              }`}>
            ...
            <div className="p-6 space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="bg-gradient-to-r from-purple-50 to-pink-50 p-6 rounded-xl border border-purple-200">
                  ...
                  <div className="space-y-3">
                    <div>
                      <label className="block text-sm font-medium text-gray-600 mb-1">Height</label>
                      <p className="text-lg font-semibold text-gray-900 bg-white p-2 rounded border text-center">
                ...
                <div className="bg-gradient-to-r from-amber-50 to-orange-50 p-6 rounded-xl border border-amber-200">
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      <label className="block text-sm font-medium text-gray-600 mb-1">Mounting Type</label>
                      <p className="text-gray-900 bg-white p-2 rounded border">
                ...
                <div className="bg-gradient-to-r from-teal-50 to-cyan-50 p-6 rounded-xl border border-teal-200">
                  ...
                  <div className="flex flex-wrap gap-3">
                    {selectedCustomization.additionalFeatures.map((feature, index) => (
                      <span key={index} className="bg-white text-teal-800 px-4 py-2 rounded-lg text-sm font-medium border border-teal-200 shadow-sm">
                        {feature}
                      </span>
                    ))}
                  </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-gradient-to-br from-green-50 to-emerald-50 p-6 rounded-xl border border-green-200 text-center">
                  <h4 className="font-bold text-lg text-green-800 mb-3 flex items-center justify-center gap-2">
                    <DollarSign size={20} />
                    Customer Budget
                  </h4>
                  <p className="text-3xl font-bold text-green-600">₱{selectedCustomization.budget || 'Not specified'}</p>
                </div>
                ...
                {selectedCustomization.deliveryDate && (
                  <div className="bg-gradient-to-br from-orange-50 to-red-50 p-6 rounded-xl border border-orange-200 text-center">
                    <h4 className="font-bold text-lg text-orange-800 mb-3 flex items-center justify-center gap-2">
                      <Calendar size={20} />
                      Preferred Delivery
                    </h4>
                    <p className="text-xl font-semibold text-orange-600">{selectedCustomization.deliveryDate}</p>
                  </div>
                )}
              </div>
              ...
              {selectedCustomization.specialInstructions && (
                <div className="bg-gradient-to-r from-slate-50 to-gray-50 p-6 rounded-xl border border-slate-200">
                  ...
                  <div className="bg-white p-4 rounded-lg border border-slate-200">
                    <p className="text-gray-700 leading-relaxed">{selectedCustomization.specialInstructions}</p>
                  </div>
                </div>
              )}

              {/* Contact Information */}
              {selectedCustomization.contactInfo && (
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    {selectedCustomization.contactInfo.phone && (
                      <div>
                        ...
                        <p className="text-gray-900 bg-white p-3 rounded-lg border font-medium">
                          {selectedCustomization.contactInfo.phone}
                        </p>
                      </div>
                    )}
                    ...
                    {selectedCustomization.contactInfo.address && (
              ...
              <div className="flex gap-4 pt-6 border-t border-gray-200">
                <button
                  ...
                  className="flex-1 bg-gradient-to-r from-[#A67B5B] to-[#8B5E3C] text-white py-4 rounded-xl hover:from-[#8B5E3C] hover:to-[#6B4423] transition-all duration-200 flex items-center justify-center gap-3 font-semibold text-lg shadow-lg"
                >
                  <DollarSign size={20} />
                  Send Quote
                </button>
